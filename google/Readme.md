...
Your Cloud Platform project in this session is set to qwiklabs-gcp-01-b9fb928d144a.
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ gcloud container clusters create webfrontend --zone $MY_ZONE --num-nodes 2Default change: VPC-native is the default mode during cluster creation for versions greater than 1.21.0-gke.1500. To create advancedYour Cloud Platform project in this session is set to qwiklabs-gcp-01-b9fb928d144a.Use “gcloud config set project [PROJECT_ID]” to change to a different project.student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ export MY_ZONE="us-west3-a"student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ gcloud container clusters create webfrontend --zone $MY_ZONE --num-nodes 2Default change: VPC-native is the default mode during cluster creation for versions greater than 1.21.0-gke.1500. To create advanced routes based clusters, please pass the `--no-enable-ip-alias` flagDefault change: During creation of nodepools or autoscaling configuration changes for cluster versions greater than 1.24.1-gke.800 a default location policy is applied. For Spot and PVM it defaults to ANY, and for all other VM kinds a BALANCED policy is used. To change the default values use the `--location-policy` flag.Note: Your Pod address range (`--cluster-ipv4-cidr`) can accommodate at most 1008 node(s).Creating cluster webfrontend in us-west3-a... Cluster is being configured...working...                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Creating cluster webCreating cluster webfrontend in us-west3-a... Cluster is being deployed...working.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        Creating cluster webfrontend in us-west3-a... Cluster is being health-checked (master is healthy)...done.                                                                
Created [https://container.googleapis.com/v1/projects/qwiklabs-gcp-01-b9fb928d144a/zones/us-west3-a/clusters/webfrontend].
To inspect the contents of your cluster, go to: https://console.cloud.google.com/kubernetes/workload_/gcloud/us-west3-a/webfrontend?project=qwiklabs-gcp-01-b9fb928d144a
...
NUM_NODES: 2
STATUS: RUNNING
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ kubectl version
...
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ kubectl get pods
NAME                    READY   STATUS    RESTARTS   AGE
nginx-9f47647b9-5p7nv   1/1     Running   0          77s
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ kubectl expose deployment nginx --port 80 --type LoadBalancer
service/nginx exposed
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ kubectl get services
NAME         TYPE           CLUSTER-IP   EXTERNAL-IP      PORT(S)        AGE
kubernetes   ClusterIP      10.36.0.1    <none>           443/TCP        7m7s
nginx        LoadBalancer   10.36.7.17   34.106.199.206   80:32327/TCP   61s
student_02_413fe6e56a51@cloudshell:~ (qwiklabs-gcp-01-b9fb928d144a)$ kubectl scale deployment nginx --replicas 3
